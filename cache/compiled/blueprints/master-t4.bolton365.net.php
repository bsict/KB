...
return [
    ...
    'timestamp' => 1575045238,
    'checksum' => '1e4c0d25a27ebe236c21624d71589dd0',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/git-sync_' => [
                'file' => 'user/plugins/git-sync_/blueprints.yaml',
                'modified' => 1574802934
            ],
    ...
    'data' => [
        'items' => [
            ...
            'plugins.git-sync_.enabled' => [
                ...
                'name' => 'plugins.git-sync_.enabled',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.folders' => [
                'type' => 'selectize',
                'multiple' => true,
                ...
                'name' => 'plugins.git-sync_.folders',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.sync' => [
                'type' => '_parent',
                'name' => 'plugins.git-sync_.sync',
                'form_field' => false
            ],
            'plugins.git-sync_.sync.on_save' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.git-sync_.sync.on_save',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.sync.on_delete' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.git-sync_.sync.on_delete',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.sync.on_media' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.git-sync_.sync.on_media',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.sync.cron_enable' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.git-sync_.sync.cron_enable',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.sync.cron_at' => [
                'type' => 'cron',
                'label' => 'Run Sync at',
                'default' => '0 12,23 * * *',
                'name' => 'plugins.git-sync_.sync.cron_at',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.local_repository' => [
                'type' => 'hidden',
                'multiple' => false,
                'size' => 'medium',
                'label' => 'Local Repository Path',
                'name' => 'plugins.git-sync_.local_repository',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.repository' => [
                'type' => 'text',
                'label' => 'Git Repository',
                'name' => 'plugins.git-sync_.repository',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.user' => [
                'type' => 'text',
                'label' => 'Git User',
                'autocomplete' => 'off',
                'name' => 'plugins.git-sync_.user',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.password' => [
                'type' => 'enc-password',
                ...
                'autocomplete' => 'off',
                'name' => 'plugins.git-sync_.password',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.webhook' => [
                'type' => 'text',
                'label' => 'Repository Web Hook URL',
                'data-default@' => '\\Grav\\Plugin\\GitSyncPlugin::generateRandomWebhook',
                'name' => 'plugins.git-sync_.webhook',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.webhook_enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.git-sync_.webhook_enabled',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.webhook_secret' => [
                'type' => 'text',
                ...
                'markdown' => true,
                'name' => 'plugins.git-sync_.webhook_secret',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.branch' => [
                'type' => 'text',
                'default' => 'master',
                'label' => 'Local Branch',
                'name' => 'plugins.git-sync_.branch',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.remote' => [
                'type' => '_parent',
                'name' => 'plugins.git-sync_.remote',
                'form_field' => false
            ],
            'plugins.git-sync_.remote.name' => [
                'type' => 'text',
                'default' => 'origin',
                'label' => 'Remote Name',
                'name' => 'plugins.git-sync_.remote.name',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.remote.branch' => [
                'type' => 'text',
                'default' => 'master',
                'label' => 'Remote Branch',
                'name' => 'plugins.git-sync_.remote.branch',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.git' => [
                'type' => '_parent',
                'name' => 'plugins.git-sync_.git',
                'form_field' => false
            ],
            'plugins.git-sync_.git.author' => [
                'type' => 'select',
                'default' => 'gituser',
                ...
                'name' => 'plugins.git-sync_.git.author',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.git.message' => [
                'type' => 'text',
                'default' => '(Grav GitSync) Automatic Commit',
                'label' => 'Commit message',
                'name' => 'plugins.git-sync_.git.message',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.git.name' => [
                'type' => 'text',
                'default' => 'GitSync',
                'label' => 'Committer Name',
                'name' => 'plugins.git-sync_.git.name',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.git.email' => [
                'type' => 'text',
                'default' => 'git-sync@trilby.media',
                'label' => 'Committer Email',
                'name' => 'plugins.git-sync_.git.email',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.git.bin' => [
                'type' => 'text',
                'default' => 'git',
                'label' => 'Git Binary Path',
                'name' => 'plugins.git-sync_.git.bin',
                'validation' => 'strict'
            ],
            'plugins.git-sync_.logging' => [
                'type' => 'toggle',
                'default' => 0,
                ...
                'name' => 'plugins.git-sync_.logging',
                'validation' => 'strict'
            ],
            'plugins.git-sync_._wizard' => [
                'type' => 'git-wizard',
                'label' => 'Text Variable',
                'name' => 'plugins.git-sync_._wizard',
                'validation' => 'strict'
            ],
            'plugins.presentation' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'git-sync_' => [
                    'enabled' => 'plugins.git-sync_.enabled',
                    'folders' => 'plugins.git-sync_.folders',
                    'sync' => [
                        'on_save' => 'plugins.git-sync_.sync.on_save',
                        'on_delete' => 'plugins.git-sync_.sync.on_delete',
                        'on_media' => 'plugins.git-sync_.sync.on_media',
                        'cron_enable' => 'plugins.git-sync_.sync.cron_enable',
                        'cron_at' => 'plugins.git-sync_.sync.cron_at'
                    ],
                    'local_repository' => 'plugins.git-sync_.local_repository',
                    'repository' => 'plugins.git-sync_.repository',
                    'user' => 'plugins.git-sync_.user',
                    'password' => 'plugins.git-sync_.password',
                    'webhook' => 'plugins.git-sync_.webhook',
                    'webhook_enabled' => 'plugins.git-sync_.webhook_enabled',
                    'webhook_secret' => 'plugins.git-sync_.webhook_secret',
                    'branch' => 'plugins.git-sync_.branch',
                    'remote' => [
                        'name' => 'plugins.git-sync_.remote.name',
                        'branch' => 'plugins.git-sync_.remote.branch'
                    ],
                    'git' => [
                        'author' => 'plugins.git-sync_.git.author',
                        'message' => 'plugins.git-sync_.git.message',
                        'name' => 'plugins.git-sync_.git.name',
                        'email' => 'plugins.git-sync_.git.email',
                        'bin' => 'plugins.git-sync_.git.bin'
                    ],
                    'logging' => 'plugins.git-sync_.logging',
                    '_wizard' => 'plugins.git-sync_._wizard'
                ],
                'presentation' => [
